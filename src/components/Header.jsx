...
import { NotebookPen, Sun, Moon, Database, ShieldCheck, Sparkles } from 'lucide-react';
import { isFirebaseConfigured } from '../firebase';

export default function Header({ darkMode, setDarkMode, onOpenFirebaseModal, completedPercentage = 0 }) {
  return (
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-3.5 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2.5 sm:gap-3">
          ...
          <button
            ...
            title={isFirebaseConfigured ? 'Connected to Firebase Firestore' : 'Click to setup Firebase Firestore credentials'}
          >
            {isFirebaseConfigured ? (
              <>
